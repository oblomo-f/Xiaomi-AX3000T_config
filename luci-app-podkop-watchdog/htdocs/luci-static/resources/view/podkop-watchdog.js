...
return view.extend({
    ...
    render: function(data) {
        ...
        var style = E('style', {}, [
            ...
            '.podkop-watchdog-page input[type="checkbox"]{width:18px!important;height:18px!important;max-width:none!important;min-width:18px!important;display:inline-block!important;}'
        ...
        var statusBox = E('div', {'class':'cbi-section'}, [
            E('h3', {}, _('Статус')),
            E('div', {'id':'podkop-watchdog-status','style':'margin-bottom:12px;'}, status.running ?
        ...
        function addField(option, title, description, type) {
            ...
            var input = E('input', {
                'type':type || 'text',
                'class': type === 'checkbox' ? '' : 'cbi-input-text',
                'value':value,
                'style': type === 'checkbox'
                    ? 'display:inline-block!important;width:18px!important;height:18px!important;margin:2px 8px 0 0!important;vertical-align:middle!important;'
                    : 'display:block;width:420px;max-width:100%;margin-top:5px;'
            });
            ...
            var block = E('div', {'style':'margin:0 0 15px 0;'}, [
                E('label', {'style': type === 'checkbox'
                    ? 'display:flex;align-items:center;font-weight:bold;margin-bottom:5px;cursor:pointer;'
                    : 'display:block;font-weight:bold;margin-bottom:3px;'}, [
                    type === 'checkbox' ? input : null,
                    type === 'checkbox' ? E('span', {}, title) : title
                ]),
