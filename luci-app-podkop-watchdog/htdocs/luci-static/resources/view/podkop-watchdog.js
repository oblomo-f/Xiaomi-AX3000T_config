...
return view.extend({
    ...
    render: function(data) {
        ...
        var style = E('style', {}, [
            ...
            '.podkop-watchdog-page .podkop-two-column-row{width:100%!important;}',
            ...
            '.podkop-watchdog-page .podkop-two-column-row{width:100%!important;}'
            '@media(max-width:700px){.podkop-watchdog-page .podkop-check-row{flex-direction:column!important;gap:12px!important}.podkop-watchdog-page .podkop-check-row>div{width:100%!important;max-width:none!important;min-width:0!important}}'
        ]);
        ...
        var checkRow = E('div', {
            ...
            'style': 'display:flex; gap:0; align-items:stretch; width:100%; margin:0 0 18px 0; border:1px solid #ddd;'
        });
