...
- **Статус Watchdog: ● Запущен** — зелёный.
- **Статус Watchdog: ● Остановлен** — красный.
- **Podkop: Установлен и работает.** — зелёный.
- **Podkop: Установлен, но не работает.** — жёлтый.
- **Podkop: Не установлен** — красный.


### Отображение статуса Podkop

В строке статуса слово **Podkop:** остаётся обычного цвета, а цветом выделяется только состояние:
- **Установлен и работает.** — зелёный.
- **Установлен, но не работает.** — жёлтый.
- **Не установлен** — красный.
